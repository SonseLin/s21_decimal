...
BUILD_STR = build
CFILES_STR_LIB = $(wildcard s21_decimal_lib/*.c)
...
MY_LIB = build/s21_decimal.a

all: s21_decimal

s21_decimal: lib tests main final
...
final:
	$(CC) $(CFLAGS) $(C11) build/main.o $(OBJS_TESTS_DONE) -o s21_decimal -L. $(MY_LIB) $(CHECK_LIBS)
...
clean:
	rm -f s21_decimal $(OBJS_STR_LIB_DONE) $(OBJS_TESTS_DONE) build/main.o $(MY_LIB)

rebuild: clean s21_decimal
